...
Если ЗагрузитьИзменения ИЛИ ЗагрузитьВсе Тогда 
	...
	Иначе
		...
		Иначе
			Если НеПолучатьИзменения Тогда
				УдалитьФайлы(ОбъединитьПути(ПутьВременногоКаталогаЗагрузки, ИмяФайлаСпискаФайлов + ".tmp"));
				ПереместитьФайл(ОбъединитьПути(ПутьВременногоКаталогаЗагрузки, ИмяФайлаСпискаФайлов), ОбъединитьПути(ПутьВременногоКаталогаЗагрузки, ИмяФайлаСпискаФайлов + ".tmp"));
			КонецЕсли;	
			...
			Если НеПолучатьИзменения Тогда
				УдалитьФайлы(ОбъединитьПути(ПутьВременногоКаталогаЗагрузки, ИмяФайлаСпискаФайлов));
				ПереместитьФайл(ОбъединитьПути(ПутьВременногоКаталогаЗагрузки, ИмяФайлаСпискаФайлов + ".tmp"), ОбъединитьПути(ПутьВременногоКаталогаЗагрузки, ИмяФайлаСпискаФайлов));
			КонецЕсли;	
		КонецЕсли;	

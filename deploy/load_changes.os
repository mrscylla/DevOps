...
Процедура РазобратьВходящиеПараметры()
	...
	Параметры.Вставить("ЗагрузитьИзменения", 		ПараметрыКС["-loadchanges"] = "true");
	Параметры.Вставить("ЗагрузитьРасширение", 		ПараметрыКС["-loadextension"] = "true");
	Параметры.Вставить("ОбновитьДампКонфигурации", 	ПараметрыКС["-updatecfgdump"] = "true");
	Параметры.Вставить("ОбновитьБазуДанных", 		ПараметрыКС["-updatedb"] = "true");
